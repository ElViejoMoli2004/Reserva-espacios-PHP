            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" id="primer_nombre" name="primer_nombre" placeholder="Primer Nombre" 
                        class="mt-1 px-3 py-2 bg-white/20 backdrop-blur-md rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-cyan-300 text-white placeholder-gray-300" required value="{{$item->primer_nombre}}">
                </div>
                <!-- Segundo Nombre -->
                <div class="col-span-1">
                    ...
                    <input type="text" id="segundo_nombre" name="segundo_nombre" placeholder="Segundo Nombre" 
                        class="mt-1 px-3 py-2 bg-white/20 backdrop-blur-md rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-cyan-300 text-white placeholder-gray-300" value="{{$item->segundo_nombre}}">
                </div>
                <!-- Primer Apellido -->
                <div class="col-span-1">
                    ...
                    <input type="text" id="primer_apellido" name="primer_apellido" placeholder="Primer Apellido" 
                        class="mt-1 px-3 py-2 bg-white/20 backdrop-blur-md rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-cyan-300 text-white placeholder-gray-300" required value="{{$item->primer_apellido}}">
                </div>
                <!-- Segundo Apellido -->
                <div class="col-span-1">
                    ...
                    <input type="text" id="segundo_apellido" name="segundo_apellido" placeholder="Segundo Apellido" 
                        class="mt-1 px-3 py-2 bg-white/20 backdrop-blur-md rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-cyan-300 text-white placeholder-gray-300" value="{{$item->segundo_apellido}}">
                </div>
                <!-- Cédula -->
                <div class="col-span-1">
                    <label for="cedula" class="block text-sm text-white">Cédula</label>
                    <input type="number" id="cedula" name="cedula" placeholder="Cédula" 
                        class="mt-1 px-3 py-2 bg-white/20 backdrop-blur-md rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-cyan-300 text-white placeholder-gray-300" required value="{{$item->cedula}}">
                </div>
                <!-- Email -->
                <div class="col-span-1">
                    <label for="email" class="block text-sm text-white">Email</label>
                    <input type="email" id="email" name="email" placeholder="Email" 
                        class="mt-1 px-3 py-2 bg-white/20 backdrop-blur-md rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-cyan-300 text-white placeholder-gray-300" required value="{{$item->email}}">
                </div>
                <!-- Contraseña -->
                <div class="col-span-1">
                    <label for="password" class="block text-sm text-white">Contraseña</label>
                    <input type="password" id="password" name="password" placeholder="Contraseña" 
                        class="mt-1 px-3 py-2 bg-white/20 backdrop-blur-md rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-cyan-300 text-white placeholder-gray-300" required value="{{$item->password}}">
                </div>
                <!-- Teléfono -->
                <div class="col-span-1">
                    <label for="telefono" class="block text-sm text-white">Teléfono</label>
                    <input type="text" id="telefono" name="telefono" placeholder="Teléfono" 
                        class="mt-1 px-3 py-2 bg-white/20 backdrop-blur-md rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-cyan-300 text-white placeholder-gray-300" required value="{{$item->telefono}}">
                </div>
                <!-- Rol ID Selector -->
